...
class CPM(nn.Module):
    def __init__(self, k):
        ...
        self.Mconv1_stage2 = nn.Conv2d(32 + self.k + 1, 128, kernel_size=11, padding=5)
        ...
        self.Mconv1_stage3 = nn.Conv2d(32 + self.k + 1, 128, kernel_size=11, padding=5)
        ...
        self.Mconv1_stage4 = nn.Conv2d(32 + self.k + 1, 128, kernel_size=11, padding=5)
        ...
        self.Mconv1_stage5 = nn.Conv2d(32 + self.k + 1, 128, kernel_size=11, padding=5)
        ...
        self.Mconv1_stage6 = nn.Conv2d(32 + self.k + 1, 128, kernel_size=11, padding=5)
